...
Parsley.addMessages('el', {
  defaultMessage: "Φαίνεται να είναι μη έγκυρη.",
  type: {
    email:        "Πρέπει να είναι ένα έγκυρο email.",
    url:          "Πρέπει να είναι ένα έγκυρο url.",
    number:       "Πρέπει να είναι ένας έγκυρος αριθμός.",
    integer:      "Πρέπει να είναι ένας έγκυρος ακέραιος.",
    digits:       "Πρέπει να είναι ψηφία.",
    alphanum:     "Πρέπει να είναι αλφαριθμητικό."
  },
  notblank:       "Δεν πρέπει να είναι κενό το πεδίο.",
  required:       "Το πεδίο αυτό απαιτείται.",
  pattern:        "Φαίνεται να είναι μη έγκυρο.",
  min:            "Πρέπει να είναι μεγαλύτερη ή ίση με %s.",
  max:            "Πρέπει να είναι μικρότερη ή ίση με %s.",
  range:          "Πρέπει να είναι μεταξύ %s και %s.",
  ...
  equalto:        "Πρέπει να είναι η ίδια."
});
